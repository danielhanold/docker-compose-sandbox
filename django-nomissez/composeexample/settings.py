...
SECRET_KEY = 'o@#g#-e#b)pn31wt)g-0e_s%kf5s$00x%g)wfxcbf!=_f0%lmg'
...
INSTALLED_APPS = (
    'elasticsearchpoc.apps.ElasticsearchpocConfig',
    'debug_toolbar',
...
DEBUG_TOOLBAR_CONFIG = {
    'SHOW_TOOLBAR_CALLBACK': 'composeexample.settings.show_toolbar',
}
