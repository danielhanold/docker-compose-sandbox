...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_future_question(self):
        ...
        response = self.client.get(reverse('polls:view_index'))
        self.assertContains(response, "No polls are available.")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])
    ...
    def test_index_view_with_future_question_and_past_question(self):
        """
        Even if both past and future questions exit, only past
        questions should be dispalyed.
        """
        create_question(question_text="Past Question.", days=-30)
        create_question(question_text="Future Question.", days=30)
        response = self.client.get(reverse('polls:view_index'))
...
class QuestionMethodTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() should return Flase for questions
...
class QuestionIndexDetailTests(TestCase):
    def test_detail_view_with_a_future_question(self):
        ...
        url = reverse('polls:view_detail', args=(future_question.id,))
    ...
    def test_detail_view_with_a_past_question(self):
        ...
        url = reverse('polls:view_detail', args=(past_question.id,))
        response = self.client.get(url)
